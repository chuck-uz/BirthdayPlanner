    ...
    <div className="flex max-w-[200px] flex-col items-end gap-2">
      {subscribed ? (
        <Button
          ...
          variant="outline"
          disabled={busy}
          className="gap-1.5 px-3 py-2 text-xs border-orange-200/80 bg-orange-50/80 text-orange-900 hover:bg-orange-100/90 dark:border-orange-900/50 dark:bg-orange-950/40 dark:text-orange-100 dark:hover:bg-orange-950/70"
      ...
      {subscribed && !canReceive ? (
        <p className="text-right text-[0.65rem] leading-snug text-amber-800 dark:text-amber-200">
